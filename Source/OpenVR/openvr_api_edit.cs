...
//
// NOTE Bitslo (developer of Cable Guardian):
// I don't really know the proper way to reliably access the openvr_api.dll 
// from anywhere else, so I just include it in my app folder.
// ...
// As I couldn't think of a better way (with minimal effort), I added 
// classes OpenVRInterop32 and OpenVRInterop64 to be able to call the
// appropriate version of openvr_api.dll. These edits are not intended
// to leave outside the Cable Guardian solution. Please DO NOT distribute
// this edited version of openvr_api.cs. 
//=============================================================================
...
public class OpenVRInterop
{
	...
	internal static bool GetRuntimePath(System.Text.StringBuilder pchPathBuffer, uint unBufferSize, ref uint punRequiredBufferSize)
	{
		if (Environment.Is64BitProcess)
			return OpenVRInterop64.GetRuntimePath(pchPathBuffer, unBufferSize, ref punRequiredBufferSize);
		else
			return OpenVRInterop32.GetRuntimePath(pchPathBuffer, unBufferSize, ref punRequiredBufferSize);
	}
...
public class OpenVRInterop32
{
	...
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_InitInternal2", CallingConvention = CallingConvention.Cdecl)]
	...
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_ShutdownInternal", CallingConvention = CallingConvention.Cdecl)]
	internal static extern void ShutdownInternal();
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_IsHmdPresent", CallingConvention = CallingConvention.Cdecl)]
	internal static extern bool IsHmdPresent();
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_IsRuntimeInstalled", CallingConvention = CallingConvention.Cdecl)]
	internal static extern bool IsRuntimeInstalled();
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_RuntimePath", CallingConvention = CallingConvention.Cdecl)]
	internal static extern string RuntimePath();
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_GetRuntimePath", CallingConvention = CallingConvention.Cdecl)]
	...
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_GetStringForHmdError", CallingConvention = CallingConvention.Cdecl)]
	internal static extern IntPtr GetStringForHmdError(EVRInitError error);
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_GetGenericInterface", CallingConvention = CallingConvention.Cdecl)]
	...
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_IsInterfaceVersionValid", CallingConvention = CallingConvention.Cdecl)]
	internal static extern bool IsInterfaceVersionValid([In, MarshalAs(UnmanagedType.LPStr)] string pchInterfaceVersion);
	[DllImportAttribute(openvr_api_dll, EntryPoint = "VR_GetInitToken", CallingConvention = CallingConvention.Cdecl)]
